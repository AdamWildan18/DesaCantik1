                ...
                <div class="QA_table visible-scroll always-visible ps-container ps-theme-default ps-active-x ps-active-y mb_3"
                    ...
                    <div id="keluarga" style="display: ">
                        <table class="table" id="append">
                            ...
                            <tbody>
                                <form class="pekerjaanform" action="/pekerjaan/update/{{ $data->id }}" method="POST">
                                    @csrf
                                {{-- @foreach ($data->penduduks as $data) --}}
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="sts_bekerja"  class="form-select form-select-sm">
                                                <option value="{{ $data->sts_bekerja }}">{{ $data->sts_bekerja }}</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <input type="number" class="form-control form-control-sm" min="0" value="{{ $data->jam_kerja }}" max="24" name="jam_kerja">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-control-sm" value="{{ $data->lapangan_kerja }}" name="lapangan_kerja">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
